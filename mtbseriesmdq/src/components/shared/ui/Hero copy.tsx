  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-12 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen w-full gap-8">
          {/* Left content */}
          <div className="lg:w-1/2 text-white mb-12 lg:mb-0">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl lg:text-2xl opacity-90">
                La carrera de MTB más emocionante de Mar del Plata
              </p>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-lg">
                    <p>Sierra de los Difuntos,</p>Ruta 226 km28.5,
                    <p>Colinas Verdes</p>
                  </span>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              <a href="#puntos_inscripcion">
                <img
                  ...
                  // src="https:/1/encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTy3AFdmhRWf5DZQjghvqgghzhcRLlOzTPxrav_g3H-ATZJJj5dazdt0nT8GhGOmVUK9xA&usqp=CAU"
                  alt="MTB Racing"
