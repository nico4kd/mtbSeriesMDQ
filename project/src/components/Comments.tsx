  ...
  const [comments, setComments] = useState([
    {
      id: 1,
      name: "María González",
      comment: "¡Increíble evento el año pasado! Ya estoy inscrita para 2025. El circuito es desafiante pero muy divertido.",
      rating: 5,
      date: "2025-01-12",
      likes: 12,
    ...
    },
    {
      ...
      comment: "Excelente organización y un ambiente súper profesional. Los premios estuvieron geniales y la atención médica fue impecable.",
      rating: 5,
      date: "2025-01-11",
      likes: 8,
    ...
    },
    {
      id: 3,
      name: "Ana Martín",
      comment: "Fue mi primera carrera de MTB y me encantó. La organización fue perfecta y todos muy amables. ¡Volveré seguro!",
      rating: 4,
      date: "2025-01-10",
      likes: 15,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Deja tu comentario</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <button className="flex items-center space-x-2 text-pink-500 hover:text-cyan-500 transition-colors duration-300">
                      <ThumbsUp size={16} />
                      <span className="text-sm font-semibold">{comment.likes} Me gusta</span>
                    </button>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-pink-500 to-cyan-400 rounded-2xl p-8 mt-12 text-white text-center">
            <h3 className="text-2xl font-bold mb-6">Estadísticas de Satisfacción</h3>
